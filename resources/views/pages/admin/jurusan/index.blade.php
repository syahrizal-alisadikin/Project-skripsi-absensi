        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" style="float: right"><i class="fas fa-plus"></i> Jurusan</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <a href="javascript:void(0)" onclick="ubahData('{{route('jurusan.update',$item->id)}}','{{$item->name}}','{{$item->id}}')" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
      ...
      <div class="modal-body">
        <form action="{{ route('jurusan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" required placeholder="Masukan Nama jurusan" >
            </div>
